...
[Area("Admin")]
[Route("admin/fieldrelayevent")]
public class FieldRelayEventController : Controller
{
    private readonly IFieldRelayEventService eventService;

    public FieldRelayEventController(IFieldRelayEventService eventService)
    {
    ...
    public IActionResult Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
    {
        ...
        return View(PaginatedList<FieldRelayEvent>.Create(events, pageNumber ?? 1, pageSize));
    }
